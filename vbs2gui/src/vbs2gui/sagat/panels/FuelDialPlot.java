 ...
 * @author sha33
 */
public class FuelDialPlot extends org.jfree.chart.plot.dial.DialPlot {
  ...
  protected void initComponents() {
    ...
    DialTextAnnotation dialtextannotation = new DialTextAnnotation("FUEL");
    ...
    StandardDialScale standarddialscale = new StandardDialScale(0.0D, 240.0D, -120D, -300D, 40D, 4);
    standarddialscale.setTickLabelPaint(Color.YELLOW);
    standarddialscale.setMajorTickPaint(Color.YELLOW);
    standarddialscale.setMinorTickPaint(Color.GREEN);
    standarddialscale.setTickRadius(0.88D);
    standarddialscale.setTickLabelOffset(0.14999999999999999D);
    standarddialscale.setTickLabelFont(new Font("Dialog", 0, 16));
    this.addScale(0, standarddialscale);
    StandardDialScale standarddialscale1 = new StandardDialScale(0.0D, 240.0D, -120D, -300D, 40D, 4);
    ...
    StandardDialRange standarddialrange1 = new StandardDialRange(0D, 240D, Color.YELLOW);
